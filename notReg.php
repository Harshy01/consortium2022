        ...
        <div class="container d-flex align-items-center justify-content-center min-vh-100">
            <div class="row text-center box mx-auto" style="max-width: 95%;">
                ...
                <div class="px-3 py-3 mx-3" style="color: #000;background-color: #fff;border-radius: 25px;width: 450px;max-width: 90%;">
                  <?php echo "<h3 style=font-weight: 600 class=pt-4><b> Sorry,</b> <br>You've not registered. Kindly proceed to registration <a style=text-decoration:none; href=register.php>here</a>. </h3>";?><br>
                </div>
            </div>
        </div>
        </div>
