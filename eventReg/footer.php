...
<body>
  <form action="store_details.php" method="post">
    ...
    <div class="col-8 col-lg-4 message" style="margin-top: 7%;" >
    ...
    <div class="d-block d-lg-none text-center my-4">
      <input class="btn btn4" name="submit" type="submit" value="Send message">
  </div>

  <div class="d-none d-lg-block my-3" style="margin-left: 73%;">
    <input class="btn btn4" name="submit" type="submit" value="Send message">
</div>


  <div class="container text-center mt-2 text-white">
    <span class="btn btn-dark rounded-circle mx-1 py-2"><a style="color: inherit;" target="_blank" role="button" type="button" href="https://www.facebook.com/vnitecell/"><i class="fa-brands fa-facebook-f"></i></a></span>
    <span class="btn btn-dark rounded-circle mx-1 py-2"><a target="_blank" style="color: inherit;" role="button" type="button" href="https://www.instagram.com/ecellvnit/?hl=en"><i class="fa-brands fa-instagram"></i></a></span>
    <span class="btn btn-dark rounded-circle mx-1 py-2"><a target="_blank" style="color: inherit;" role="button" type="button" href="https://www.linkedin.com/company/theentrepreneurshipcellvnit/"><i class="fa-brands fa-linkedin-in"></i></a></span>
    <span class="btn btn-dark rounded-circle mx-1 py-2"><a target="_blank" style="color: inherit;" role="button" type="button" href="https://www.youtube.com/ECellVNIT"><i class="fa-brands fa-youtube"></i></a></span>
